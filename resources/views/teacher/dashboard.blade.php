    ...
    <div class="flex items-center">
        ...
        <div class="relative" x-data="{ open: false }">
            <button @click="open = !open" class="flex items-center focus:outline-none">
                ...
                <span class="ml-2 text-sm font-medium text-gray-700 hidden md:inline">{{ Auth::guard('teacher')->user()->name }}</span>
        ...
        <div class="flex-1 overflow-y-auto">
                <nav class="p-4">
                    <div class="space-y-1">
                        ...
                        <!-- Grades -->
                        <a href="{{ route('teacher.grades') }}" class="flex items-center p-3 rounded-lg sidebar-menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    ...
    <form method="POST" action="{{ route('teacher.logout') }}" class="w-full">
        ...
        <div class="p-6">
            <div class="max-w-7xl mx-auto">
                <!-- Welcome Header -->
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-gray-900">Welcome back, {{ Auth::guard('teacher')->user()->name }}</h1>
