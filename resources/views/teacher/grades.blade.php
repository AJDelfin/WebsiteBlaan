        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 overflow-y-auto">
                <nav class="p-4">
                    <div class="space-y-1">
                        <!-- Dashboard -->
                        <a href="{{ route('teacher.dashboard') }}" class="flex items-center p-3 rounded-lg sidebar-menu-item">
                        ...
                        <!-- Grades -->
                        <a href="{{ route('teacher.grades') }}" class="flex items-center p-3 rounded-lg sidebar-menu-item bg-green-50 text-green-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
