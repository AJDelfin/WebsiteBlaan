<x-app-layout>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const showToast = "{{ session('show_login_toast') }}";
    ...
    background: 
        ...
        url("{{ asset('images/iw-2024-philippines.jpg') }}");
    ...
    <footer class="modern-footer">
        <div class="footer-grid">
            <div>
                <a href="{{ route('dashboard') }}" class="footer-logo">Blaan Learning</a>
        ...
        <div class="footer-bottom">
            &copy; {{ date('Y') }} Blaan Learning. All rights reserved.
        </div>
    </footer>
