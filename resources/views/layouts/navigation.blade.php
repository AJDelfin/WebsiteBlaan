    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        <!-- School Logo -->
                        <img src="{{ asset('images/MaligyaElemSchool.jpg') }}" alt="Maligaya Elementary School Logo" 
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('blaan')" :active="request()->routeIs('blaan')">
                        {{ __('Blaan Language') }}
                    </x-nav-link>
                </div>
            </div>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('blaan')" :active="request()->routeIs('blaan')">
                    {{ __('Blaan Language') }}
                </x-responsive-nav-link>
            </div>
