        ...
        <div class="flex items-center">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" class="flex items-center focus:outline-none">
                    <img class="w-8 h-8 rounded-full" src="{{ asset('images/profile.png') }}" alt="User avatar">
                    <span class="hidden md:inline ml-2 text-sm font-medium text-gray-700">{{ Auth::guard('admin')->user()->name }}</span>
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex-1 overflow-y-auto">
                <nav class="p-4">
                    <div class="space-y-1">
                        <!-- Dashboard -->
                        <a href="{{ route('admin.dashboard') }}" class="flex items-center p-3 rounded-lg sidebar-menu-item bg-green-50 text-green-600">
                        ...
                        <div class="sidebar-menu">
                            ...
                            <div class="sidebar-submenu pl-11">
                                ...
                                <a href="{{ route('admin.teacher') }}" class="block py-2 px-3 rounded-lg text-sm hover:bg-gray-100">Teachers</a>
...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Welcome back, {{ Auth::guard('admin')->user()->name }}. Here's an overview of your school management system.</p>
</div>
