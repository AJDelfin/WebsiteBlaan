    ...
    <div class="container mx-auto px-6 py-4">
        ...
        <div class="flex justify-center items-center">
            ...
            <nav class="hidden md:flex space-x-8 mx-auto">
                <a href="{{ route('dashboard') }}" class="nav-link text-gray-800 hover:text-green-700 font-medium">Dashboard</a>
                <a href="{{ route('translate') }}" class="nav-link text-gray-800 hover:text-green-700 font-medium">Translate</a>
                <a href="{{ route('features') }}" class="nav-link text-gray-800 hover:text-green-700 font-medium text-green-600">Features</a>
            </nav>
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4 text-center">
            <a href="{{ route('dashboard') }}" class="block py-2 text-gray-800 hover:text-green-700">Dashboard</a>
            <a href="{{ route('translate') }}" class="block py-2 text-gray-800 hover:text-green-700">Translate</a>
            <a href="{{ route('features') }}" class="block py-2 text-gray-800 hover:text-green-700 font-medium text-green-600">Features</a>
            <div class="border-t border-gray-200 mt-2 pt-2">
                <a href="{{ route('profile.edit') }}" class="block py-2 text-gray-800 hover:text-green-700">Profile</a>
                <form action="{{ route('logout') }}" method="POST" class="inline">
                    @csrf
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white bg-opacity-10 p-8 rounded-xl backdrop-filter backdrop-blur-sm card-hover">
                    <img src="{{ asset('images/blaan-clothing.jpg') }}" alt="Blaan Traditional Clothing" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white bg-opacity-10 p-8 rounded-xl backdrop-filter backdrop-blur-sm card-hover">
                    <img src="{{ asset('images/blaan-music.jpg') }}" alt="Blaan Music and Dance" class="w-full h-48 object-cover rounded-lg mb-4">
                ...
                <div class="bg-white bg-opacity-10 p-8 rounded-xl backdrop-filter backdrop-blur-sm card-hover">
                    <img src="{{ asset('images/blaan-handicrafts.jpg') }}" alt="Blaan Handicrafts" class="w-full h-48 object-cover rounded-lg mb-4">
            ...
            <div class="text-center mt-12">
                <a href="{{ route('blaan') }}" class="inline-block border-2 border-white text-white hover:bg-white hover:text-green-700 px-8 py-3 rounded-full font-semibold transition-all">
    ...
    <footer class="bg-gray-900 text-white pt-12 pb-6 mt-auto">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('translate') }}" class="text-gray-400 hover:text-white">Translate</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="{{ route('blaan') }}" class="hover:text-white">Blaan Language</a></li>
            ...
            <div class="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">&copy; {{ date('Y') }} Blaan Learning. All rights reserved.</p>
