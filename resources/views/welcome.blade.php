...
<head>
    ...
    <style>
        ...
        .hero-image {
            ...
            width: 100%;
            height: 100%;
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("{{ asset('images/MaligyaElemSchool.jpg') }}");
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <!-- School Logo -->
                    <img src="{{ asset('images/MaligyaElemSchool.jpg') }}" alt="Maligaya Elementary School Logo" class="school-logo rounded-full border-2 border-green-600">
                    <div>
                ...
                <nav class="hidden md:flex space-x-8">
                    <a href="{{ route('welcome') }}" class="nav-link text-gray-800 hover:text-green-700 font-medium">Home</a>
...
<div class="relative">
    ...
    <div id="login-dropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
        ...
        <!-- Staff Section -->
        <div>
            <a href="{{ route('teacher.login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 border-b border-gray-100">
                <div class="flex items-center">
            ...
            <a href="{{ route('admin.login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                <div class="flex items-center">
...
<div id="mobile-menu" class="hidden md:hidden mt-4 pb-4">
    <a href="{{ route('welcome') }}" class="block py-2 text-gray-800 hover:text-green-700">Home</a>
    ...
    <div class="border-t border-gray-200 mt-2 pt-2">
        ...
        <a href="{{ route('login') }}" class="block px-6 py-2 text-sm text-gray-800 hover:text-green-700">Login</a>
        <a href="{{ route('register') }}" class="block px-6 py-2 text-sm text-gray-800 hover:text-green-700">Register</a>
        
        <div class="font-medium text-sm px-4 py-2 text-gray-500 mt-2">Staff</div>
        <a href="{{ route('teacher.login') }}" class="block px-6 py-2 text-sm text-gray-800 hover:text-green-700">Teacher Login</a>
        <a href="{{ route('admin.login') }}" class="block px-6 py-2 text-sm text-gray-800 hover:text-green-700">Admin Login</a>
    </div>
</div>
    </header>
            ...
            <div class="hero-content container mx-auto">
                <div class="max-w-2xl">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <a href="{{ route('login') }}" class="bg-yellow-600 hover:bg-yellow-700 text-white px-8 py-3 rounded-full font-semibold text-center transition-all">
                            Start Learning
                        </a>
    ...
    <section class="py-16 blaan-pattern-bg text-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="{{ route('register') }}" class="bg-yellow-600 hover:bg-yellow-700 text-white px-8 py-3 rounded-full font-semibold inline-block transition-all">
                    Register Now
                </a>
    ...
    <footer class="bg-gray-900 text-white pt-12 pb-6">
        <div class="container mx-auto px-6">
            ...
            <div class="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">&copy; {{ date('Y') }} Blaan Indigenous Learning Center. All rights reserved.</p>
