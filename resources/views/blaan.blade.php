...
<body>
    <header>
        <div class="nav-container">
            <a href="{{ route('dashboard') }}" class="logo" style="text-decoration: none; display: inline-block; padding: 12px 20px; ">Indigenous Learn</a>
            <nav class="nav-links">
                <a href="{{ route('dashboard') }}">Dashboard</a>
                <a href="{{ route('translate') }}">Translate</a>
    ...
    <main>
        <section id="blaan-culture" class="culture-section">
            ...
            <div class="culture-image-container">
                <img src="{{ asset('images/blaanCulture.png') }}" alt="Blaan Culture" class="culture-image">
            </div>
        ...
        <div id="flyout-menu" class="flyout-menu">
            <div class="level-container">
                <div class="level-box">
                    ...
                    <a href="{{ route('blaanLevel') }}" class="btn">Learn Basic</a>
                </div>
                <div class="level-box">
    ...
    <section class="cta">
        ...
        <a href="{{ route('register') }}" class="btn">Sign Up Today</a>
    </section>
