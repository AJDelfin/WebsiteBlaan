        ...
        <div class="flex-1 overflow-y-auto">
                <nav class="p-4">
                    <div class="space-y-1">
                        ...
                        <!-- Grades -->
                        <a href="<?php echo e(route('teacher.grades')); ?>" class="flex items-center p-3 rounded-lg sidebar-menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
...
</html><?php /**PATH F:\xampp\htdocs\Blaan_Multi_Role\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>